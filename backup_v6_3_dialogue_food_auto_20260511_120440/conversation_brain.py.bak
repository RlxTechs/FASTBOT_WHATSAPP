...
def generate_human_sales_reply(message: str, chat_id: str = "default") -> Dict[str, Any]:
    ...
    # 1) Produits officiels products.json en priorité : iPhone, XR, 12 Pro Max, imprimante, laptop, TV...
